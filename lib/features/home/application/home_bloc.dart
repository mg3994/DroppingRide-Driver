...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  Future<void> getDirection(
    ...
    NativeService().initService(
        ...
        screenHeight: 120);
    minHeight = -(MediaQuery.sizeOf(navigatorKey.currentContext!).height * 0.7);
    if (bottomSize == 0.0) {
      bottomSize =
          -(MediaQuery.sizeOf(navigatorKey.currentContext!).height * 0.7);
...
//  Locations
  Future<void> getCurrentLocation(
    ...
    if (status.isGranted || status.isLimited) {
      ...
      showToast(
          message: AppLocalizations.of(navigatorKey.currentContext!)!.getYourCurrentLocation);
  ...
  waitingTime() async {
    ...
    if (val.child('trip_distance').value != null) {
      distance = double.parse(val.child('trip_distance').value.toString());
    }
