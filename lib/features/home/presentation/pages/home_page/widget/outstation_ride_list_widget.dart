                                                    ...
                                                    onTap: () {
                                                      context.read<HomeBloc>().add(ShowBidRideEvent(
                                                          id: context.read<HomeBloc>().outStationList[key]
                                                              ['request_id'],
                                                          pickLat: context.read<HomeBloc>().outStationList[key]
                                                              ['pick_lat'],
                                                          pickLng: context.read<HomeBloc>().outStationList[key]
                                                              ['pick_lng'],
                                                          dropLat: context.read<HomeBloc>().outStationList[key]
                                                              ['drop_lat'],
                                                          dropLng: context
                                                                  .read<HomeBloc>()
                                                                  .outStationList[key]
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          if (context.read<HomeBloc>().outStationList[
                                                                      ...
                                                                      null &&
                                                                  context.read<HomeBloc>().outStationList[
                                                                              key]['drivers']['driver_${userData!.id}']
                                                                          [
                                                                          "is_rejected"] ==
                                                                      'by_user' ||
                                                              context
