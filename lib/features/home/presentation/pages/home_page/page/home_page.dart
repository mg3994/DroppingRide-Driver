                                ...
                                (context.read<HomeBloc>().choosenMenu == 0)
                                    ...
                                    : (context.read<HomeBloc>().choosenMenu ==
                                        ...
                                        ? (userData?.role == 'driver')
                                            ? (userData == null) ? Center(child: CircularProgressIndicator.adaptive(),):const LeaderboardPage()
                                            : OwnerDashboard(
                                        ...
                                        : (context
                                                ...
                                                2)
                                            ? const EarningsPage()
                                            : (userData == null) ? Center(child:CircularProgressIndicator.adaptive()):AccountPage(
