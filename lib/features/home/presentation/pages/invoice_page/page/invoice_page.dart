...
import 'package:restart_tagxi/features/home/presentation/pages/invoice_page/widget/invoice_top_painter.dart';
import 'package:restart_tagxi/l10n/app_localizations.dart';
import '../../../../../../common/pickup_icon.dart';

class InvoicePage extends StatelessWidget {
  final BuildContext cont;
  const InvoicePage({super.key, required this.cont});
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  if (userData!.onTripRequest!.isBidRide ==
                                          '0' &&
                                            ...
                                            if (userData!.onTripRequest!
                                              ...
                                              FareBreakdownWidget(
                                                 ...
                                                 name: AppLocalizations.of(context)!
                                                      .basePrice,
                                                 price: '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.basePrice}'),
                                            if (userData!
                                                    .onTripRequest!
                                                    .requestBill!
                                                    .distancePrice !=
                                              ...
                                              FareBreakdownWidget(
                                                 ...
                                                 name:  AppLocalizations.of(context)!
                                                      .distancePrice,
                                                 price:  '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.distancePrice}'),
                                            if (userData!.onTripRequest!
                                              ...
                                              FareBreakdownWidget(
                                                 ...
                                                 name: AppLocalizations.of(context)!
                                                      .timePrice,
                                                  price: '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.timePrice}'),
                                            if (userData!
                                                    .onTripRequest!
                                                    .requestBill!
                                                    .waitingCharge !=
                                              ...
                                              FareBreakdownWidget(
                                                 cont:
                                                  context,
                                                 name: '${AppLocalizations.of(context)!.waitingPrice} (${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.waitingChargePerMin} x ${userData!.onTripRequest!.requestBill!.calculatedWaitingTime} mins)',
                                                 price:  '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.waitingCharge}'),
                                            if (userData!
                                                    .onTripRequest!
                                                    .requestBill!
                                                    .adminCommission !=
                                              ...
                                              FareBreakdownWidget(
                                                 ...
                                                 name: AppLocalizations.of(context)!
                                                      .convFee,
                                                 price: '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.adminCommission}'),
                                            if (userData!.onTripRequest!
                                              ...
                                              FareBreakdownWidget(
                                               ...
                                               name:   AppLocalizations.of(context)!
                                                      .taxes,
                                                price:  '${userData!.onTripRequest!.requestBill!.currencySymbol}${userData!.onTripRequest!.requestBill!.serviceTax}'),
                                          ],
                                        ),
                                      ],
                                    ),
