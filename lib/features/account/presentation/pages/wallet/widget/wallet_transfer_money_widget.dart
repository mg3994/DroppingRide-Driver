            ...
            children: [
              Padding(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  children: [
                    MyText(text: AppLocalizations.of(context)?.transferMoney,textStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold),),
                    ...
                    DropdownButtonFormField(
                      ...
                      // helperStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Center(child: MyText(text: userData!.currencySymbol)),
                        prefixIconConstraints: BoxConstraints(maxWidth: size.width * 0.1)
                      ),
                    ),
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Center(child: Icon(Icons.phone_android,size: 20)),
                        prefixIconConstraints: BoxConstraints(maxWidth: size.width * 0.1)
                      ),
                    ),
                    SizedBox(
