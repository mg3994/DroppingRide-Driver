...
class WithdrawMoneyWalletWidget extends StatelessWidget {
  ...
  const WithdrawMoneyWalletWidget({super.key, required this.cont});
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: MyText(
                              text:
                                  '${userData!.currencySymbol.toString()}100'),
                        ),
                      ),
                      SizedBox(
                        width: size.width * 0.05,
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: MyText(
                              text:
                                  '${userData!.currencySymbol.toString()}500'),
                        ),
                      ),
                      SizedBox(
                        width: size.width * 0.05,
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: MyText(
                              text:
                                  '${userData!.currencySymbol.toString()}1000'),
                        ),
                      ),
                    ],
                  ),
