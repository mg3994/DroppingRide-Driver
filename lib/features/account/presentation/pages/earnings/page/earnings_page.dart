                                                            ...
                                                            if (int.parse(context
                                                              ...
                                                              if (DateTime.now()
                                                                      .difference(DateFormat('dd-MMM-yy').parse(context
                                                                          ...
                                                                          .toString()
                                                                          .replaceFirst(
                                                                              context.read<AccBloc>().earningsList[context.read<AccBloc>().choosenEarningsWeeks!].fromDate.toString().split('-')[0],
                                                                              k.toString().split('-')[1])))
                                                                      .inHours >=
                                                                  0) {
                                                                display = true;
                                                              ...
                                                              if (DateTime.now()
                                                                      .difference(DateFormat('dd-MMM-yy').parse(context
                                                                          ...
                                                                          .toString()
                                                                          .replaceFirst(
                                                                              context.read<AccBloc>().earningsList[context.read<AccBloc>().choosenEarningsWeeks!].toDate.toString().split('-')[0],
                                                                              k.toString().split('-')[1])))
                                                                      .inHours >=
                                                                  0) {
                                                                display = true;
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              border: Border.all(color: (display) ? Theme.of(context).primaryColorDark.withOpacity(0.5) : Colors.transparent),
                                                                              color: (context.read<AccBloc>().choosenEarningsDate == k) ? Theme.of(context).primaryColorDark.withOpacity(0.5) : Colors.transparent),
                                                                          alignment:
                                                                              Alignment.center,
                                                                          child:
                                                                              MyText(
                      ...
                      if (context.read<AccBloc>().earningsList.isNotEmpty)
                        Positioned(
                            ...
                            child: Container(
                              ...
                              height: ((widget.args != null &&
                                      widget.args!.from! == 'dashboard'))
                                  ? (size.height - size.width * 0.96) +
                                      size.width * 0.22
