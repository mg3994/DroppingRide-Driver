              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child:  Center(child: Icon(Icons.edit,color: Theme.of(context).primaryColorDark)),
                  ),
                )
              ],
            ),
        ...
        child: InkWell(
          onTap: () {
            showModalBottomSheet(
              ...
              context: context,
              builder: (cont) {
                return SelectCountryWidget(countries: arg.countryList,cont: context);
              },
            );
          },
          child: Row(
            children: [
              ...
              MyText(text: context.read<AuthBloc>().dialCode,textStyle: Theme.of(context).textTheme.labelLarge?.copyWith(fontWeight: FontWeight.bold),),
            ],
          ),
        ),
      ),
